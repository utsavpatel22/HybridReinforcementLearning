...
class Environment(object):
    def __init__(self, agent):
        ...
        self.linear_acc_limit = 1.0
        self.angular_acc_limit = 2.0
        self.del_t = 0.1

        rospy.Subscriber('/turtlebot0/scan_filtered', LaserScan, self.scan_callback)
        rospy.Subscriber('/turtlebot0/ground_truth/state', Odometry, self.odom_callback)
    ...
    def send_command(self, act):
        ...
        print("The min value {}".format((self.vel[0] - (self.linear_acc_limit * self.del_t))))
        print("The max value {}".format((self.vel[0] + (self.linear_acc_limit * self.del_t))))
        print("The current velocity {}".format(self.vel[0]))
